...
#define EFD_SEMAPHORE_LINUX 0x000001
#define EFD_NONBLOCK_LINUX  O_NDELAY_LINUX
#define EFD_CLOEXEC_LINUX   O_CLOEXEC_LINUX

#define MREMAP_MAYMOVE_LINUX   0x0001
#define MREMAP_FIXED_LINUX     0x0002
#define MREMAP_DONTUNMAP_LINUX 0x0004
